    ...
    class МирТрудМай
   {
      static void Main(string[] args)
      {
       ...
       Console.WriteLine("Введите значение переменной a:");
        ...
        Console.WriteLine($"Cтоимость конфет: {стоимостьКонфет} рублей");
        Console.WriteLine($"Cтоимость печенья: {стоимостьПеченья} рублей");
        Console.WriteLine($"Cтоимость яблок: {стоимостьЯблок} рублей");
